...
useEffect(() => {
  ...
  useEffect(() => {
    ...
    const timeoutId = setTimeout(() => {
      ...
      if (currentPathname.startsWith('/products/')) {
        ...
        // مثال: /Goalkeeperequipment/black/size-large
        const pathParts = currentPathname.split('/').filter(p => p);
  ...
  useEffect(() => {
    ...
    if (selectedCategorySlug) {
      ...
      // مثال: /Goalkeeperequipment/black/size-large
      // إزالة أي path segments موجودة من pathname (مثل /Goalkeeperequipment/black -> /Goalkeeperequipment)
            ...
            onSelectCategory={(catId) => {
              ...
              if (selectedCat) {
                if (catId === selectedCategoryId) {
                  ...
                  router.push('/Goalkeeperequipment', { scroll: false });
                } else {
